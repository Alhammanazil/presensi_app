...
class Jabatan extends BaseController
{
    ...
    public function store()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            session()->setFlashdata('berhasil', 'Data jabatan tersimpan');
    ...
    public function update($id)
    {
        ...
        if (!$this->validate($rules)) {
            ...
            session()->setFlashdata('berhasil', 'Data jabatan diupdate');
            return redirect()->to(base_url('admin/jabatan'));
        }
    }
    ...
    function delete($id)
    {
        ...
        if ($jabatan) {
            ...
            session()->setFlashdata('berhasil', 'Data jabatan dihapus');
            return redirect()->to(base_url('admin/jabatan'));
        }
    }
}
